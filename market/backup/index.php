...
$(function () {
   ...
   title: {
        ...
        xAxis: {
		       ...
		       categories: ['Bank', 'Engineering','DSE30', 'Food & Allied', 'Fuel & Power', 'Jute','Textile','Pharmaceuticals','Paper & Printing','Serv. & R. Estate', 'Cement','Miscellaneous','Insurance','NBFI','IT Sector','Travel & Leisure','Ceramics','Mutual Funds','Tannery','Telecom'],
			   labels: {
                    rotation: -45,
                    align: 'right',
                    style: {
  ...
  legend: {
    ...
    series: [{
			name: 'Index Changes',
            data: [3.5, 4.2, 11.5, 5.2, -0.051, -2.5, -4.25, 5, 5, 6.6, 3.3, 5.2,12.5,4.2,1.5,2.5,3.5,3.6,4.9,7.8],
			color: '#008000',
...
for (var i=0;i < data.length;i++) {
   ...
   title: {
        ...
        xAxis: {
		       ...
		       categories: ['BDWELDING','BEDL','DESCO','EASTRNLUB','GBBPOWER','JAMUNAOIL','KPCL','LINDEBD','MJLBD','MPETROLEUM','PADMAOIL','POWERGRID',
'SPPCL','SUMITPOWER','TITASGAS'],
			   labels: {
                    rotation: -45,
                    align: 'right',
  ...
  legend: {
    ...
    series: [{
			name: 'Price Changes',
            data: [-3.5, 4.2, 1.5, 5.2, -0.051, -2.5, -4.25, 5, 5, 6.6, 3.3, 5.2,12.5,-2.2,1.2],
			color: '#008000',
			negativeColor: '#FF0000'
       }]
    });
  ...
  <div class="row"> 
    ...
    <div class="col-md-3">
      <div class="sidebar-menu">
        <ul>
          <li class="active"><a href="#">Market Stats</a></li>
          <li><a href="sectorIndex.php">Sector Index Change</a></li>
    ...
    <div class="col-md-9">
      ...
      <div class="row">
        ...
        <div class="col-md-6 placeholder left">
         <div id="sector" style="height: 400px"></div>
        </div>
       </div>
