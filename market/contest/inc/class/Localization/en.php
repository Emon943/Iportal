...
class en extends Handler
{
    ...
    public function getActivationEmail()
    {
        ...
        $email['subject'] = 'Iportal Contest : Account Activation required';

        $email['head']  = 'MIME-Version: 1.0' . "\r\n";
        $email['head'] .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        $email['head'] .= 'From: Iportal Contest <no-reply@capmadvisorybd.com>' . "\r\n";

        $email['body'] = 'Hello,' . "\r\n";
        $email['body'] .= '<br/><br/>' . "\r\n";
        $email['body'] .= 'You recently created an account on Iportal Contest.' . "\r\n";
        $email['body'] .= '<br/>' . "\r\n";
    ...
    public function getResetEmail()
    {
        ...
        $email['subject'] = 'Iportal Contest : Password reset request';

        $email['head']  = 'MIME-Version: 1.0' . "\r\n";
        $email['head'] .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        $email['head'] .= 'Iportal Contest <no-reply@capmadvisorybd.com>' . "\r\n";

        $email['body'] = 'Hello,' . "\r\n";
		$email['body'] .= '<br/><br/>' . "\r\n";
		$email['body'] .= 'You recently requested a password reset request at Iportal Contest.' . "\r\n";
		$email['body'] .= '<br/>' . "\r\n";
