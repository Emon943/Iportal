...
<div id="page-wrap">
    ...
    <i class="glyphicon glyphicon-remove-circle pull-right closed-chat" onclick="toggleChat();"></i>

	<i onclick="toggleChat();" class="btn-open-chat">Open Chat »</i>
    </div>
...
<script type="text/javascript">
function toggleChat() {
	$('.closed-chat').slideToggle();
	$('.btn-open-chat').slideToggle();
}
    //On key change 
