...
<div class="row header">
  ...
  <div class="col-md-6 col-lg-6 col-sm-6">
    <div class="clearfix pull-right"><a href="?page=home" class="btn btn-primary btn-sm "><i class="glyphicon glyphicon-home"></i> Home</a> <a href="?page=accounts&cid=<?php echo $contest_id; ?>" class="btn btn-default btn-sm "><i class="glyphicon glyphicon-euro"></i> Accounts</a> <a href="?page=change-password" class="btn btn-warning btn-sm "><i class="glyphicon glyphicon-lock"></i> Change Password</a> <a href="?page=change-email" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-envelope"></i> Change Email</a> <a href="?page=logout" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-off"></i> Logout</a> </div>
  </div>
</div>
<div class="row">
...
?>
          <td><a class="stockInfo" href="#" rel="<?php echo $info['code'].','. $info['ID']; ?>"><?php echo $stk = $info['code'];?></a><br>
...
<div class="row">
  <!-- <div class="col-md-3 chatbox">
    <div onclick="toggleChat();" class="btn-close-chat pull-right"><i class="glyphicon glyphicon-remove-circle"></i></div>
    <div id="page-wrap">
      <h2>Contest Chat</h2>
      <p id="name-area"></p>
      <div id="chat-wrap">
  ...
  <div onclick="toggleChat();" class="btn-open-chat">Open Chat »</div>
</div>
