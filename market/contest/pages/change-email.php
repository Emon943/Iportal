...
<div class="col-md-4 center-block form">
	...
	<form id="changeemail" method="post" class="form-signin">
		<input type="text" name="email" id="email" placeholder="New Email Address" class="form-control" /><br/>
		<input type="password" name="password" id="password" placeholder="Password" class="form-control" /><br/>
		<input type="submit" id="changeemail" value="Change Email" class="btn btn-lg btn-info btn-block btn-rounded" />
	</form>
...
$(document).ready(function(){
	...
	echo '	$("#message").message({type: "info", dismiss: false, message: "<h4>Your email address is currently <strong>' . $email . '</strong></h4>"});' . "\r\n";
