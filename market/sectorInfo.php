  ...
  <?php include_once("navigation.php"); ?>
    ...
    <div class="col-md-9">
      ...
      <div class="row">
        ...
        <h2 class="pull-left"><?php sectorName($id = $_GET['sectorID']) ?> </h2>
      ...
      <select name='sectorID' onChange="this.form.submit()">
        ...
        <td><span class="pull-left">High<br/><small>0.00</small></span></td>

        <td>&nbsp;</td>

        <td><span class="pull-right">Low<br/><small>0.00</small></span></td>
...
$query = sectorData($id = $_GET['sectorID']);// Daily Stock arket table					
...
?>          						<td><a href="" title="" target="_blank"><?php echo $info['code']; ?></a></td>
                        ...
                        <td class="center"><?php echo number_format($info['total_value']); ?></td>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="secondaryprice">
                    ...
                    <div class="tabbed-padding">
                      ...
                      <script type="text/javascript"><?php stockGraphClosePrice($id = $_GET['sectorID']); ?></script> 
                  ...
                  <div class="tab-pane" id="secondaryvolume">
                    ...
                    <div class="tabbed-padding">
                      ...
                      <div id="closingvolumechart" style="height: 600px"></div>
                       ...
                       <script type="text/javascript"><?php stockGraphVolume($id = $_GET['sectorID']); ?></script> 
                  ...
                  <div class="tab-pane" id="secondaryvalue">
                    ...
                    <div class="tabbed-padding">
                       ...
                       <script type="text/javascript"><?php stockGraphValue($id = $_GET['sectorID']); ?></script> 
                  ...
                  <script type="text/javascript"><?php stockGraphTrade($id = $_GET['sectorID']); ?></script> 
                  ...
                  <div class="tab-pane" id="secondarychange">
                    ...
                    <div class="tabbed-padding">
                      ...
                      <script type="text/javascript"><?php stockGraphChanges($id = $_GET['sectorID']); ?></script> 
