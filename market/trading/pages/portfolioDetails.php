...
<div class="row header">
  ...
  <div class="col-md-6 col-lg-6 col-sm-6">
    <div class="clearfix pull-right"><a href="?page=home" class="btn btn-primary btn-sm "><i class="glyphicon glyphicon-home"></i> Home</a> <a href="?page=accounts&id=<?php echo $_GET['id']; ?>" class="btn btn-default btn-sm "><i class="glyphicon glyphicon-euro"></i> Accounts</a> <a href="?page=change-password" class="btn btn-warning btn-sm "><i class="glyphicon glyphicon-lock"></i> Change Password</a> <a href="?page=change-email" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-envelope"></i> Change Email</a> <a href="?page=logout" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-off"></i> Logout</a> </div>
  </div>
</div>
<div class="row"> 
...
?>
                ...
                <td class="sum"><?php $buyprice = ($stk*$info['buy_price']); echo number_format(($buyprice+$com),2);
                          $total_buy += ($buyprice+$com);?> TK</td>
                <td><?php $sellPrice = ($info['ltp']*$stk); 
                          $totalsell += $sellPrice;
                          $sell_com = (($info['ltp']*$stk)*.5/100);
                          $gl += ($sellPrice-$buyprice);
                          echo number_format(($sellPrice-$buyprice),2);?> TK</td>
                
                <td><?php
                    $sellValue +=($lastTradePrice*$stk);

                 echo number_format($stk*($sellPrice-$buyprice),2); ?></td>
              ...
              <tr class="summary success">
                ...
                <td></td>
                <td></td>
                <td><?php echo number_format($total_buy,2); ?> TK</td>
                <td><?php echo number_format($gl,2); ?> TK</td>
                <td></td>
                <td></td>
                <td><?php echo number_format($sellValue,2);?> TK</td>
              </tr>
            </tbody>
          </table>
        </div>
...
$('#gt_tbp').html(commaSeparateNumber(sum) + " TK");
    ...
    $(".buy").click(function () {
        cid = $(this).attr("value");
        pid = <?php echo $portfolio_id ; ?>;

           
        location.href = "?page=order&company_id="+cid+"&pid="+pid;
